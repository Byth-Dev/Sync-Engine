...
class PreferencesMenu extends ui.OptionsState.Page
{
	...
	public function new()
	{
		...
		createPrefItem('Camera Zoom on Beat', 'camera-zoom', true);
		createPrefItem('FPS Counter', 'fps-counter', true);
		createPrefItem('Auto Pause', 'auto-pause', false);
		createPrefItem('Ghost Tapping', 'ghost-tap', false);
		createPrefItem('Vanilla HUD', 'vanilla-hud', false);
		createPrefItem('Watermark', 'watermark', true);
		createPrefItem('Preload Assets', 'preload-graphics', true);
	...
	public static function initPrefs():Void
	{
		...
		preferenceCheck('vanilla-hud', false);
		preferenceCheck('watermark', true);
		preferenceCheck('preload-graphics', true);
